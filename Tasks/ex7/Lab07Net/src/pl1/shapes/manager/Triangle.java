 ...
 * @version 3.00.002
 */
public class Triangle implements IPaintable,IEvaluable,IClickable{
...
//== TESTY A METODA MAIN =======================================================
    ...
    public void paint(MyGraphics graphics) {
         graphics.fillPolygon(this.getVertices()[0], this.getVertices()[1], this.getColor());
    }

    @Override
    public double calcArea() {
        return this.height*this.width/2; //To change body of generated methods, choose Tools | Templates.
    }
