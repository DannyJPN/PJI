 ...
 * @version 3.00.002
 */
public class Ellipse implements IPaintable,IEvaluable,IClickable {
...
//== TESTY A METODA MAIN =======================================================
    ...
    public double calcArea() {
       return Math.PI*width*height; //To change body of generated methods, choose Tools | Templates.
    }
