...
public class Canvas {
  ...
  private Canvas(Stage primaryStage) {
    canvasPanel = new CanvasPanel(700, 700);
  ...
  private void create(ActionEvent event) throws InterruptedException {
    ...
    int y = rnd.nextInt((maxy + 1) - miny) + miny;
    //TODO vytvorit novy tvar;
    System.out.println("x: " + x + ", y: " + y);
     Forest f = new Forest( x, y, (int)(Canvas.getInstance().getWidth()),(int)Canvas.getInstance().getHeight() , 10, 20, 50);
